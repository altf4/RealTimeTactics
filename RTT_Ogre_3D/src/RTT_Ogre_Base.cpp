...
void RTT_Ogre_Base::createCamera(void)
{
    ...
    rttCamera->setPosition(Ogre::Vector3(5.5,10.5,6.5)); // Center on the gameboard and position above
    rttCamera->lookAt(Ogre::Vector3(5.5,0,-4)); // Look back along -Z slightly for an "isometric" like view
